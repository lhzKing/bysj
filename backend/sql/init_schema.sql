...
CREATE TABLE trace_code (
  ...
  code_status VARCHAR(32) NOT NULL DEFAULT 'GENERATED' COMMENT 'GENERATED/PRINTED/ACTIVATED/IN_STOCK/IN_TRANSIT/TRANSFERRED/EXCEPTION/VOIDED/SCRAPPED',
...
CREATE TABLE trace_lifecycle_log (
  ...
  action_type VARCHAR(32) NOT NULL COMMENT 'INIT/PRINT_CODE/REPRINT_CODE/ACTIVATE_CODE/VOID_CODE/PACK/UNPACK/PALLETIZE/UNPALLETIZE/INBOUND/OUTBOUND/TRANSFER/DELIVER/EXCEPTION/EXCEPTION_OPEN/EXCEPTION_CLOSE/CORRECTION',
