...
ALTER TABLE trace_lifecycle_log
  MODIFY COLUMN action_type VARCHAR(32) NOT NULL
    COMMENT 'INIT/PRINT_CODE/REPRINT_CODE/ACTIVATE_CODE/VOID_CODE/PACK/UNPACK/PALLETIZE/UNPALLETIZE/INBOUND/OUTBOUND/TRANSFER/EXCEPTION/EXCEPTION_OPEN/EXCEPTION_CLOSE/CORRECTION';
