...
public class TraceTransitionPolicy {
    ...
    private static Map<TraceStatus, Map<ActionType, TraceStatus>> createTransitions() {
        ...
        // EXCEPTION is treated as a frozen state in the minimal loop. Only CORRECTION
        // is allowed and is handled separately because it does not change status.
        transitions.put(TraceStatus.EXCEPTION, Map.of());
